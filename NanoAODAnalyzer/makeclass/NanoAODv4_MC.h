...
// Thu Jul 25 04:29:54 2019 by ROOT version 6.12/07
// from TTree Events/Events
// found on file: C5D5AF70-6B15-6746-8DD5-E20B1A5609B2.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         Electron_mvaSpring16GP[5];   //[nElectron]
   Float_t         Electron_mvaSpring16HZZ[5];   //[nElectron]
   ...
   Int_t           Electron_cutBased_HLTPreSel[5];   //[nElectron]
   Int_t           Electron_cutBased_Spring15[5];   //[nElectron]
   Int_t           Electron_cutBased_Sum16[5];   //[nElectron]
   ...
   Int_t           Electron_vidNestedWPBitmapSpring15[5];   //[nElectron]
   Int_t           Electron_vidNestedWPBitmapSum16[5];   //[nElectron]
   ...
   Bool_t          Electron_mvaSpring16GP_WP80[5];   //[nElectron]
   Bool_t          Electron_mvaSpring16GP_WP90[5];   //[nElectron]
   Bool_t          Electron_mvaSpring16HZZ_WPL[5];   //[nElectron]
   UInt_t          nFatJet;
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[95];   //[nGenPart]
   Float_t         GenPart_mass[95];   //[nGenPart]
   Float_t         GenPart_phi[95];   //[nGenPart]
   Float_t         GenPart_pt[95];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[95];   //[nGenPart]
   Int_t           GenPart_pdgId[95];   //[nGenPart]
   Int_t           GenPart_status[95];   //[nGenPart]
   Int_t           GenPart_statusFlags[95];   //[nGenPart]
   ...
   Float_t         Photon_mvaID17[6];   //[nPhoton]
   ...
   Int_t           Photon_cutBased17Bitmap[6];   //[nPhoton]
   ...
   Bool_t          Photon_mvaID17_WP80[6];   //[nPhoton]
   Bool_t          Photon_mvaID17_WP90[6];   //[nPhoton]
...
#ifdef NanoAODv4_cxx
NanoAODv4::NanoAODv4(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("C5D5AF70-6B15-6746-8DD5-E20B1A5609B2.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("C5D5AF70-6B15-6746-8DD5-E20B1A5609B2.root");
      }
...
Int_t NanoAODv4::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t NanoAODv4::LoadTree(Long64_t entry)
{
...
void NanoAODv4::Init(TTree *tree)
{
...
void NanoAODv4::Show(Long64_t entry)
{
...
Int_t NanoAODv4::Cut(Long64_t entry)
{
